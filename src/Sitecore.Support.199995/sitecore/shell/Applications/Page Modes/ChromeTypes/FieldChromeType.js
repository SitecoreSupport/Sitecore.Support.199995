Sitecore.PageModes.ChromeTypes.Field = Sitecore.PageModes.ChromeTypes.ChromeType.extend({
  constructor: function () {
    ...
    //END SUPPORT FIX 140555 (FOR IE11) [part1]
    this.base();
  ...
  //SUPPORT FIX 140555 (FOR IE11) [part2] adds additional field types in condition (this.fieldType == "single-line text" || this.fieldType == "multi-line text")
  _tryUpdateFromWatermark: function () {
    if (this.watermarkHTML &&
        (this.chrome.element.html() == "" || (this.fieldType == "text" || this.fieldType == "rich text" || this.fieldType == "single-line text" || this.fieldType == "multi-line text") && $sc.removeTags(this.chrome.element.html()) == "")) {
      this.chrome.element.update(this.watermarkHTML);
      this.chrome.element.attr("scWatermark", "true");
    }
  }
  //END SUPPORT FIX 140555 (FOR IE11) [part2]
},
{
